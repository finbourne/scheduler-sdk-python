...
from finbourne_scheduler.api_client import ApiClient as AsyncApiClient
...
import finbourne_scheduler.extensions.retry as retry
from finbourne_scheduler.extensions.socket_keep_alive import keep_alive_socket_options
from finbourne_scheduler.extensions.tcp_keep_alive_connector import TcpKeepAliveConnector
import os
...
def build_client(
    ...
    try:
        ...
        # Set the proxy for finbourne_scheduler if needed

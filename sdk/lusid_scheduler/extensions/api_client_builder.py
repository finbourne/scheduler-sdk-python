...
from lusid_scheduler.api_client import ApiClient as AsyncApiClient
...
import lusid_scheduler.extensions.retry as retry
from lusid_scheduler.extensions.socket_keep_alive import keep_alive_socket_options
from lusid_scheduler.extensions.tcp_keep_alive_connector import TcpKeepAliveConnector
import os
...
def build_client(
    ...
    try:
        ...
        # Set the proxy for lusid_scheduler if needed
